...
<!--当前时间-->
	<a><li style="float:left"><?php 
		...
		<li><a href="../html/addBook.html" class="a">图书捐赠&nbsp;&nbsp;&nbsp;&nbsp;</a></li>		
                <li><a href="memberSpace.php" class="a">个人中心&nbsp;&nbsp;|&nbsp;&nbsp;</a></li>
...
<?php
	echo "<p align='center'>";
	if($page>1)
		echo "<a href='memberIndex.php?page=".($page-1)."'>上一页</a>";
	for($i=1;$i<=$total_pages;$i++)
	{
		if($i==$page)
		echo "$i";
		else
		echo "<a href='memberIndex.php?page=$i'>$i</a>";
		
	}
	if($page<$total_pages)
		echo "<a href='memberIndex.php?page=".($page+1)."'>下一页</a>";
	        echo "</p>";
?>
